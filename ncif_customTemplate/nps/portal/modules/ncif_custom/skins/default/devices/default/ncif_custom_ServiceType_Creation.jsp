...
//      c.set("TaskHeader.iconAlt", c.var("TranslatedClass"));
      ...
      c.set("TaskHeader.iconUrl", c.plus("dir/", "ncifServiceType.gif"));
      c.set("TaskHeader.iconAlt", ncsUtil_ncif_custom.getProperty( "ObjectType.ncifServiceType" ));
   %>
   ...
   <TR>
      <TD align="left" colspan="2">
			<%=	ncsUtil_ncif_custom.getProperty( "ObjectType.ncifServiceType" )	%> name:<font color="red">*</font>&nbsp;&nbsp;
      </TD>
   </TR>
   <TR>
      <TD>

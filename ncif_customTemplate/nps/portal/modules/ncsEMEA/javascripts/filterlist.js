...
//  Example:
//    
//        <Select name='my_list' size='10' onclick='my_list_selected( this );' >
//          ...
//        </SELECT>
//        
//        <INPUT name='my_text' type='text' onKeyUp="myText_Changed( this.value );" >
//
//       
//       <SCRIPT>
//          var my_filter = new filterlist( document.forms[0].my_list );
//          
//          function myText_Changed( my_value )
//          {
//            my_filter.set( my_value );
//          }
//       </SCRIPT>
//  
//  
/*==================================================*
 $Id: filterlist.js,v 1.1 2005/06/03 16:03:38 wschreiber Exp $
